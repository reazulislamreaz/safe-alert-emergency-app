    ...
    <div className="w-full">
        ...
        {options.map((digit) => {
          ...
          return (
            <button
              ...
              className={`h-12 sm:h-14 rounded-2xl text-lg sm:text-xl font-semibold flex items-center justify-center transition-all duration-150 touch-manipulation border ${
                isSelected
      ...
      <div className="mt-3 min-h-5 flex items-center">
        {value ? (
          ...
          <p className="text-xs text-gray-400">Select any digit (0-9) for instant emergency access</p>
        )}
      </div>
    </div>
  );
